...
const Home = (props: HomeProps) => {
  ...
  const [solanaExplorerLink, setSolanaExplorerLink] =
    useState<string>('');
  ...
  const [whitelistTokenBalance, setWhitelistTokenBalance] =
    useState(0);
...
>>>>>>> 62b0da0e5c7b915caa81f65700ca7a9c68ff17b6
              ...
              <div>
                {wallet &&
                  ...
                  whitelistTokenBalance > 0 && (
                    <h3>
                      You have {whitelistTokenBalance} whitelist
                      mint(s) remaining.
                    </h3>
                  )}
                {wallet && isActive && (
            ...
            <DesContainer>
              <Des elevation={2}>
                ...
                <p>
                  ...
                  hospitality business, utilizing the power of the
                  Solana blockchain.
                </p>

                <p>
                  Hotel & Hostel Chain -with all the amenities for
                  digital nomads, co-working spaces, gym, shared
                  kitchen, bars, pool. It will be open to everyone.
                </p>

                <p>
                  Gather with the NFT community IRL, either if you
                  come for a holiday or for a longer period while
                  working remotely.
                </p>
              </Des>
              <Des elevation={2}>
                <LogoAligner>
                  <img src="palmverselogo.png" alt=""></img>
                  <GoldTitle>TOKEN STAKING</GoldTitle>
                </LogoAligner>
                {/* <p>
                  Premium beach locations, easy access to water sports
                  like surfing, canoeing.
                </p> */}
              </Des>
              <div
                style={{
